...
#define CID_LUT 14
#define CID_HL 15
#define CID_IO_PRINT 16
#define FID_RCOL 0
#define FID_RCOL_K12 1
#define FID_RCOL_K13 2
#define FID_RCOL_J12 3
#define FID_U32_SHOW_GO 4
#define FID_HFOLD 5
#define FID_HFOLD_K17 6
#define FID_HFOLD_K18 7
#define FID_HFOLD_J17 8
#define FID_REND 9
#define FID_REND_K26 10
#define FID_REND_K27 11
#define FID_U32_SHOW 12
#define FID_MAIN 13
#define FID_MAIN_K30 14
#define FID_MAIN_K31 15
#define FID_IO_PRINT 16
#define FID_IO_EMIT 17
#define FID_CLO_APPLY 18
#define FID_EXIT 19
#define FID_ENTER 20
CONSTV u8 FID_ARITY_T[] = { 11, 12, 2, 2, 3, 3, 11, 16, 16, 2, 10, 2, 1, 0, 1, 1, 2, 1, 2 };
CONSTV u8 FID_FLAG_T[] = { 0, 0, 2, 2, 2, 0, 0, 2, 2, 1, 0, 2, 2, 0, 2, 2, 2, 2, 0 };
CONSTV u8 FID_RESW_T[] = { 0, 1, 1, 0, 0, 0, 8, 8, 0, 0, 8, 1, 0, 0, 1, 1, 0, 0, 0 };
CONSTV u8 CID_ARITY_T[] = { 2, 0, 2, 2, 1, 2, 1, 1, 0, 1, 0, 0, 0, 1, 8, 8, 2 };
#define STAT_LEN 2
...
#define WL_SAVE(V) (V)[0] = r0; (V)[1] = r1; (V)[2] = r2; (V)[3] = r3; (V)[4] = r4; (V)[5] = r5; (V)[6] = r6; (V)[7] = r7;

#define WL_TAKE(V) r0 = (V)[0]; r1 = (V)[1]; r2 = (V)[2]; r3 = (V)[3]; r4 = (V)[4]; r5 = (V)[5]; r6 = (V)[6]; r7 = (V)[7];

#define WL_SIG Env e, Stk sp, u32 seq, u32 rn, Term r0, Term r1, Term r2, Term r3, Term r4, Term r5, Term rp, Term r6, Term r7, Term r8, Term r9, Term r10, Term r11, Term r12, Term r13, Term r14, Term r15

#define WL_ALL e, sp, seq, rn, r0, r1, r2, r3, r4, r5, rp, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15

#define WL_TABLE WL_X(FID_RCOL) WL_X(FID_RCOL_K12) WL_X(FID_RCOL_K13) WL_X(FID_RCOL_J12) WL_X(FID_U32_SHOW_GO) WL_X(FID_HFOLD) WL_X(FID_HFOLD_K17) WL_X(FID_HFOLD_K18) WL_X(FID_HFOLD_J17) WL_X(FID_REND) WL_X(FID_REND_K26) WL_X(FID_REND_K27) WL_X(FID_U32_SHOW) WL_X(FID_MAIN) WL_X(FID_MAIN_K30) WL_X(FID_MAIN_K31) WL_X(FID_IO_PRINT) WL_X(FID_IO_EMIT) WL_X(FID_CLO_APPLY) WL_X(FID_EXIT)
...
CONSTV u64 STAT_IMG[] = { 48ull, term_pak(CID_SNIL, 0) };

INLINE Term spin_1(Env e, THR Term* o, u32 r0, u32 r1, u32 r2) {
  u32 wpoll = 0;
  u32 v_5 = 0;
  u32 x_1 = r0;
  u32 y_1 = r1;
...
INLINE Term spin_0(Env e, THR Term* o, u32 r0, u32 r1, u32 r2) {
  ...
  WL_SPIN
    u32 v_4 = 0;
    Term o_0[1];
    if (spin_1(e, o_0, x_0, y_0, U32_BIN(t_0, ==, 0)) == 0) {
      return 0;
    }
    v_4 = o_0[0];
    v_3 = v_4;
...
INLINE Term spin_2(Env e, THR Term* o, u32 r0) {
  ...
  WL_SPIN
    ...
    u32 v_5 = 0;
    Term o_0[1];
    if (spin_0(e, o_0, (a_1 >= 32 ? 0 : U32_BIN(v_2, >>, a_1)), 0ull, 4278190080ull) == 0) {
      return 0;
    }
    v_5 = o_0[0];
    v_4 = v_5;
    v_3 = U32_BIN((a_0 >= 32 ? 0 : U32_BIN(v_2, >>, a_0)), |, v_4);
  break;
  }
  o[0] = v_3;
  return 1;
...
INLINE Term spin_3(Env e, THR Term* o, u32 r0) {
  u32 wpoll = 0;
  u32 v_10 = 0;
  u32 b_0 = r0;
  WL_SPIN
...
INLINE Term spin_4(Env e, THR Term* o, Term r0, u32 r1, u32 r2, u32 r3, u32 r4, u32 r5, u32 r6) {
  u32 wpoll = 0;
  u32 v_1 = 0;
  Term n_0 = r0;
  u32 cr_1 = r1;
  ...
  WL_SPIN
    if (n_0 == 0) {
      ...
      u32 v_3 = 0;
      Term o_0[1];
      if (spin_2(e, o_0, U32_BIN(zr_0, *, zr_0)) == 0) {
        return 0;
      }
      v_3 = o_0[0];
      v_2 = v_3;
      ...
      u32 v_5 = 0;
      Term o_1[1];
      if (spin_2(e, o_1, U32_BIN(zi_0, *, zi_0)) == 0) {
        return 0;
      }
      v_5 = o_1[0];
      v_4 = v_5;
      ...
      u32 v_7 = 0;
      Term o_2[1];
      if (spin_3(e, o_2, U32_BIN(U32_BIN(v_2, +, v_4), >, 1024ull)) == 0) {
        return 0;
      }
      v_7 = o_2[0];
      v_6 = v_7;
      u32 e2_0 = U32_BIN(esc_0, |, v_6);
      u32 nzr_0 = U32_BIN(U32_BIN(v_2, -, v_4), +, cr_1);
      u32 v_8 = 0;
      u32 v_9 = 0;
      Term o_3[1];
      if (spin_2(e, o_3, U32_BIN(2ull, *, U32_BIN(zr_0, *, zi_0))) == 0) {
        return 0;
      }
      v_9 = o_3[0];
      v_8 = v_9;
      u32 nzi_0 = U32_BIN(v_8, +, ci_1);
      u32 v_10 = 0;
      u32 v_11 = 0;
      Term o_4[1];
      if (spin_0(e, o_4, e2_0, nzr_0, zr_0) == 0) {
        return 0;
      }
      v_11 = o_4[0];
      v_10 = v_11;
      ...
      u32 v_13 = 0;
      Term o_5[1];
      if (spin_0(e, o_5, e2_0, nzi_0, zi_0) == 0) {
        return 0;
      }
      v_13 = o_5[0];
      v_12 = v_13;
      ...
      u32 v_15 = 0;
      Term o_6[1];
      if (spin_3(e, o_6, U32_BIN(e2_0, ==, 0)) == 0) {
        return 0;
      }
      v_15 = o_6[0];
      v_14 = v_15;
...
INLINE Term spin_5(Env e, THR Term* o, u32 r0, Term r1) {
  u32 wpoll = 0;
  u32 v_2 = 0;
  u32 id_0 = r0;
  Term tn_1 = r1;
  WL_SPIN
    Term a_0 = U32_BIN(U32_BIN(id_0, &, 4095ull), *, 768ull);
    Term a_1 = 4096ull;
    u32 cr_0 = U32_BIN(((u32)(a_1) == 0 ? 0 : U32_BIN(a_0, /, a_1)), -, 512ull);
    Term a_2 = 12ull;
    Term a_3 = U32_BIN((a_2 >= 32 ? 0 : U32_BIN(id_0, >>, a_2)), *, 768ull);
    Term a_4 = 4096ull;
    u32 ci_0 = U32_BIN(((u32)(a_4) == 0 ? 0 : U32_BIN(a_3, /, a_4)), -, 384ull);
    u32 v_3 = 0;
    Term o_0[1];
    if (spin_4(e, o_0, tn_1, cr_0, ci_0, 0ull, 0ull, 0ull, 0ull) == 0) {
      return 0;
    }
    v_3 = o_0[0];
    v_2 = v_3;
...
INLINE Term spin_6(Env e, THR Term* o, u32 r0, Term r1) {
  u32 wpoll = 0;
  u32 v_6 = 0;
  u32 it_0 = r0;
  Term tn_2 = r1;
  WL_SPIN
    Term a_5 = U32_BIN(it_0, *, 8ull);
    Term a_6 = ((u64)(u32)(tn_2));
    u32 bq_0 = ((u32)(a_6) == 0 ? 0 : U32_BIN(a_5, /, a_6));
    u32 v_7 = 0;
    u32 v_8 = 0;
    Term o_2[1];
    if (spin_3(e, o_2, U32_BIN(bq_0, >, 7ull)) == 0) {
      return 0;
    }
    v_8 = o_2[0];
    v_7 = v_8;
    u32 v_9 = 0;
    Term o_3[1];
    if (spin_0(e, o_3, v_7, bq_0, 7ull) == 0) {
      return 0;
    }
    v_9 = o_3[0];
    v_6 = v_9;
...
INLINE Term spin_7(Env e, THR Term* o, u32 r0, Term r1, u32 r2, u32 r3, u32 r4, u32 r5, u32 r6, u32 r7, u32 r8, u32 r9) {
  u32 wpoll = 0;
  u32 v_1 = 0;
  u32 i_1 = r0;
  Term tn_1 = r1;
  ...
  WL_SPIN
    ...
    u32 v_7 = 0;
    Term o_2[1];
    if (spin_3(e, o_2, U32_BIN(v_4, ==, 0ull)) == 0) {
      return 0;
    }
    v_7 = o_2[0];
    v_6 = v_7;
    ...
    u32 v_9 = 0;
    Term o_3[1];
    if (spin_3(e, o_3, U32_BIN(v_4, ==, 1ull)) == 0) {
      return 0;
    }
    v_9 = o_3[0];
    v_8 = v_9;
    ...
    u32 v_11 = 0;
    Term o_4[1];
    if (spin_3(e, o_4, U32_BIN(v_4, ==, 2ull)) == 0) {
      return 0;
    }
    v_11 = o_4[0];
    v_10 = v_11;
    ...
    u32 v_13 = 0;
    Term o_5[1];
    if (spin_3(e, o_5, U32_BIN(v_4, ==, 3ull)) == 0) {
      return 0;
    }
    v_13 = o_5[0];
    v_12 = v_13;
    ...
    u32 v_15 = 0;
    Term o_6[1];
    if (spin_3(e, o_6, U32_BIN(v_4, ==, 4ull)) == 0) {
      return 0;
    }
    v_15 = o_6[0];
    v_14 = v_15;
    ...
    u32 v_17 = 0;
    Term o_7[1];
    if (spin_3(e, o_7, U32_BIN(v_4, ==, 5ull)) == 0) {
      return 0;
    }
    v_17 = o_7[0];
    v_16 = v_17;
    ...
    u32 v_19 = 0;
    Term o_8[1];
    if (spin_3(e, o_8, U32_BIN(v_4, ==, 6ull)) == 0) {
      return 0;
    }
    v_19 = o_8[0];
    v_18 = v_19;
    ...
    u32 v_21 = 0;
    Term o_9[1];
    if (spin_3(e, o_9, U32_BIN(v_4, ==, 7ull)) == 0) {
      return 0;
    }
    v_21 = o_9[0];
    v_20 = v_21;
    u32 col_0 = U32_BIN(U32_BIN(v_6, *, k0_1), +, U32_BIN(U32_BIN(v_8, *, k1_1), +, U32_BIN(U32_BIN(v_10, *, k2_1), +, U32_BIN(U32_BIN(v_12, *, k3_1), +, U32_BIN(U32_BIN(v_14, *, k4_1), +, U32_BIN(U32_BIN(v_16, *, k5_1), +, U32_BIN(U32_BIN(v_18, *, k6_1), +, U32_BIN(v_20, *, k7_1))))))));
    v_1 = U32_BIN(U32_BIN(col_0, *, U32_BIN(U32_BIN(i_1, *, 2654435761ull), +, 1)), +, v_2);
  break;
  }
  o[0] = v_1;
  return 1;
...
INLINE Term spin_8(Env e, THR Term* o, Term r0, u32 r1, Term r2, u32 r3, u32 r4, u32 r5, u32 r6, u32 r7, u32 r8, u32 r9, u32 r10) {
  u32 wpoll = 0;
  u32 v_8 = 0;
  u32 v_9 = 0;
  u32 v_10 = 0;
  ...
  WL_SPIN
    if (j_0 == 0) {
      ...
      u32 v_17 = 0;
      Term o_0[1];
      if (spin_5(e, o_0, U32_BIN(i_1, +, ((u64)(u32)(p_0))), tn_1) == 0) {
        return 0;
      }
      v_17 = o_0[0];
      v_16 = v_17;
      ...
      u32 v_21 = 0;
      Term o_2[1];
      if (spin_3(e, o_2, U32_BIN(v_18, ==, 0ull)) == 0) {
        return 0;
      }
      v_21 = o_2[0];
      v_20 = v_21;
      ...
      u32 v_23 = 0;
      Term o_3[1];
      if (spin_3(e, o_3, U32_BIN(v_18, ==, 1ull)) == 0) {
        return 0;
      }
      v_23 = o_3[0];
      v_22 = v_23;
      ...
      u32 v_25 = 0;
      Term o_4[1];
      if (spin_3(e, o_4, U32_BIN(v_18, ==, 2ull)) == 0) {
        return 0;
      }
      v_25 = o_4[0];
      v_24 = v_25;
      ...
      u32 v_27 = 0;
      Term o_5[1];
      if (spin_3(e, o_5, U32_BIN(v_18, ==, 3ull)) == 0) {
        return 0;
      }
      v_27 = o_5[0];
      v_26 = v_27;
      ...
      u32 v_29 = 0;
      Term o_6[1];
      if (spin_3(e, o_6, U32_BIN(v_18, ==, 4ull)) == 0) {
        return 0;
      }
      v_29 = o_6[0];
      v_28 = v_29;
      ...
      u32 v_31 = 0;
      Term o_7[1];
      if (spin_3(e, o_7, U32_BIN(v_18, ==, 5ull)) == 0) {
        return 0;
      }
      v_31 = o_7[0];
      v_30 = v_31;
      ...
      u32 v_33 = 0;
      Term o_8[1];
      if (spin_3(e, o_8, U32_BIN(v_18, ==, 6ull)) == 0) {
        return 0;
      }
      v_33 = o_8[0];
      v_32 = v_33;
      ...
      u32 v_35 = 0;
      Term o_9[1];
      if (spin_3(e, o_9, U32_BIN(v_18, ==, 7ull)) == 0) {
        return 0;
      }
      v_35 = o_9[0];
      v_34 = v_35;
      ...
      r1 = i_1;
      r2 = tn_1;
      r3 = U32_BIN(h0_0, +, v_20);
      r4 = U32_BIN(h1_0, +, v_22);
      r5 = U32_BIN(h2_0, +, v_24);
      r6 = U32_BIN(h3_0, +, v_26);
      r7 = U32_BIN(h4_0, +, v_28);
      r8 = U32_BIN(h5_0, +, v_30);
      r9 = U32_BIN(h6_0, +, v_32);
      r10 = U32_BIN(h7_0, +, v_34);
      j_0 = r0;
      i_1 = r1;
      tn_1 = r2;
      h0_0 = r3;
...
INLINE Term spin_9(Env e, THR Term* o, u32 r0, u32 r1, u32 r2, u32 r3, u32 r4, u32 r5, u32 r6, u32 r7, u32 r8, u32 r9, u32 r10, u32 r11, u32 r12, u32 r13, u32 r14, u32 r15) {
  u32 wpoll = 0;
  u32 v_44 = 0;
  u32 v_45 = 0;
  u32 v_46 = 0;
  ...
  u32 b_23 = r15;
  WL_SPIN
    v_44 = U32_BIN(a_26, +, b_16);
    v_45 = U32_BIN(a_27, +, b_17);
    v_46 = U32_BIN(a_28, +, b_18);
    v_47 = U32_BIN(a_29, +, b_19);
    v_48 = U32_BIN(a_30, +, b_20);
    v_49 = U32_BIN(a_31, +, b_21);
    v_50 = U32_BIN(a_32, +, b_22);
    v_51 = U32_BIN(a_33, +, b_23);
  break;
  }
  o[0] = v_44;
  o[1] = v_45;
...
INLINE Term spin_10(Env e, THR Term* o, u32 r0, u32 r1, u32 r2, u32 r3, u32 r4, u32 r5, u32 r6, u32 r7) {
  u32 wpoll = 0;
  u32 v_16 = 0;
  u32 v_17 = 0;
  u32 v_18 = 0;
  ...
  u32 h_15 = r7;
  WL_SPIN
    u32 c1_0 = U32_BIN(h_8, +, h_9);
    u32 c2_0 = U32_BIN(c1_0, +, h_10);
    u32 c3_0 = U32_BIN(c2_0, +, h_11);
    u32 c4_0 = U32_BIN(c3_0, +, h_12);
    u32 c5_0 = U32_BIN(c4_0, +, h_13);
    u32 c6_0 = U32_BIN(c5_0, +, h_14);
    u32 c7_0 = U32_BIN(c6_0, +, h_15);
    Term a_0 = U32_BIN(h_8, *, 255ull);
    Term a_1 = U32_BIN(c1_0, *, 255ull);
    Term a_2 = U32_BIN(c2_0, *, 255ull);
    Term a_3 = U32_BIN(c3_0, *, 255ull);
    Term a_4 = U32_BIN(c4_0, *, 255ull);
    Term a_5 = U32_BIN(c5_0, *, 255ull);
    Term a_6 = U32_BIN(c6_0, *, 255ull);
    Term a_7 = U32_BIN(c7_0, *, 255ull);
    v_16 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_0, /, c7_0));
    v_17 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_1, /, c7_0));
    v_18 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_2, /, c7_0));
    v_19 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_3, /, c7_0));
    v_20 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_4, /, c7_0));
    v_21 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_5, /, c7_0));
    v_22 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_6, /, c7_0));
    v_23 = ((u32)(c7_0) == 0 ? 0 : U32_BIN(a_7, /, c7_0));
  break;
  }
  o[0] = v_16;
  o[1] = v_17;
...
// ========
  ...
  WL_CASE(FID_RCOL)
  {
    ...
    if (d_0 == 0) {
      u32 v_0 = 0;
      Term o_10[1];
      if (spin_7(e, o_10, i_0, tn_0, k0_0, k1_0, k2_0, k3_0, k4_0, k5_0, k6_0, k7_0) == 0) {
        return 0;
      }
      v_0 = o_10[0];
      r0 = v_0;
      ...
      if (!seq) {
        Term a_0 = 1ull;
        u64 t_0 = task_node(e, FID_RCOL_J12, WL_CONT, WL_IDX, 2);
        u64 t_1 = task_node(e, FID_RCOL, term_tsk(FID_RCOL_J12, t_0), 0, 0);
        e.mem[t_1 + 0] = p_0;
        e.mem[t_1 + 1] = i_0;
        e.mem[t_1 + 2] = tn_0;
        e.mem[t_1 + 3] = k0_0;
        ...
        e.mem[t_1 + 9] = k6_0;
        e.mem[t_1 + 10] = k7_0;
        e.mem[t_0 + 0] = term_tsk(FID_RCOL, t_1);
        u64 t_2 = task_node(e, FID_RCOL, term_tsk(FID_RCOL_J12, t_0), 1, 0);
        e.mem[t_2 + 0] = p_0;
        e.mem[t_2 + 1] = U32_BIN(i_0, +, (p_0 >= 32 ? 0 : U32_BIN(a_0, <<, p_0)));
        e.mem[t_2 + 2] = tn_0;
        e.mem[t_2 + 3] = k0_0;
        e.mem[t_2 + 4] = k1_0;
        e.mem[t_2 + 5] = k2_0;
        ...
        e.mem[t_2 + 9] = k6_0;
        e.mem[t_2 + 10] = k7_0;
        e.mem[t_0 + 1] = term_tsk(FID_RCOL, t_2);
        return term_tsk(FID_RCOL_J12, t_0);
      }
      WL_ROOM(12);
      STK(0) = p_0;
      STK(1) = i_0;
  ...
  WL_CASE(FID_RCOL_K12)
  {
    ...
    WL_PUSHN(2);
    r0 = p_1;
    r1 = U32_BIN(i_2, +, (p_1 >= 32 ? 0 : U32_BIN(a_2, <<, p_1)));
    r2 = tn_2;
    r3 = k0_2;
    r4 = k1_2;
    r5 = k2_2;
  ...
  WL_CASE(FID_U32_SHOW_GO)
  {
    ...
    if (f_0 == 0) {
      ...
      if (s_0 == 1) {
        ...
        e.mem[nd_0 + 0] = U32_BIN(48ull, +, ((u32)(a_1) == 0 ? n_0 : U32_BIN(n_0, %, a_1)));
        e.mem[nd_0 + 1] = acc_0;
        r0 = g_0;
        r1 = ((u32)(a_0) == 0 ? 0 : U32_BIN(n_0, /, a_0));
        r2 = term_ctr(CID_SCON, nd_0);
        f_0 = r0;
        n_0 = r1;
        acc_0 = r2;
  ...
  WL_CASE(FID_HFOLD)
  {
    ...
    if (d_0 == 0) {
      ...
      u32 v_7 = 0;
      Term o_10[8];
      if (spin_8(e, o_10, 64ull, i_0, tn_0, 0ull, 0ull, 0ull, 0ull, 0ull, 0ull, 0ull, 0ull) == 0) {
        return 0;
      }
      v_0 = o_10[0];
      v_1 = o_10[1];
      ...
      if (!seq) {
        Term a_0 = 64ull;
        u64 t_0 = task_node(e, FID_HFOLD_J17, WL_CONT, WL_IDX, 2);
        u64 t_1 = task_node(e, FID_HFOLD, term_tsk(FID_HFOLD_J17, t_0), 0, 0);
        e.mem[t_1 + 0] = p_1;
        e.mem[t_1 + 1] = i_0;
        e.mem[t_1 + 2] = tn_0;
        e.mem[t_0 + 0] = term_tsk(FID_HFOLD, t_1);
        u64 t_2 = task_node(e, FID_HFOLD, term_tsk(FID_HFOLD_J17, t_0), 8, 0);
        e.mem[t_2 + 0] = p_1;
        e.mem[t_2 + 1] = U32_BIN(i_0, +, (p_1 >= 32 ? 0 : U32_BIN(a_0, <<, p_1)));
        e.mem[t_2 + 2] = tn_0;
        e.mem[t_0 + 8] = term_tsk(FID_HFOLD, t_2);
        return term_tsk(FID_HFOLD_J17, t_0);
      }
      WL_ROOM(4);
      STK(0) = p_1;
      STK(1) = i_0;
  ...
  WL_CASE(FID_HFOLD_K17)
  {
    ...
    WL_PUSHN(9);
    r0 = p_2;
    r1 = U32_BIN(i_2, +, (p_2 >= 32 ? 0 : U32_BIN(a_9, <<, p_2)));
    r2 = tn_2;
    WL_JMP(FID_HFOLD);
  }}

  WL_CASE(FID_HFOLD_K18)
  {
    WL_POPN(11);
    u32 a_10 = STK(3);
    u32 a_11 = STK(4);
    ...
    r14 = b_6;
    r15 = b_7;
    WL_JMP(FID_HFOLD_J17);
  }}

  WL_CASE(FID_HFOLD_J17)
  {
    u32 a_18 = r0;
    u32 a_19 = r1;
    u32 a_20 = r2;
    ...
    u32 v_43 = 0;
    Term o_11[8];
    if (spin_9(e, o_11, a_18, a_19, a_20, a_21, a_22, a_23, a_24, a_25, b_8, b_9, b_10, b_11, b_12, b_13, b_14, b_15) == 0) {
      return 0;
    }
    v_36 = o_11[0];
    v_37 = o_11[1];
  ...
  WL_CASE(FID_REND)
  {
    ...
    if (seq) {
      ...
      u64 t_0 = task_node(e, FID_REND_K26, WL_CONT, WL_IDX, 1);
      e.mem[t_0 + 0] = hd_0;
      e.mem[t_0 + 1] = tn_0;
      WL_CONT = term_tsk(FID_REND_K26, t_0);
      WL_IDX = 2;
    }
    r0 = hd_0;
    r1 = 0ull;
  ...
  WL_CASE(FID_REND_K26)
  {
    ...
    u32 v_15 = 0;
    Term o_0[8];
    if (spin_10(e, o_0, h_0, h_1, h_2, h_3, h_4, h_5, h_6, h_7) == 0) {
      return 0;
    }
    v_8 = o_0[0];
    v_9 = o_0[1];
    ...
    v_6 = v_14;
    v_7 = v_15;
    u32 m1_0 = U32_BIN(U32_BIN(v_0, *, 2654435761ull), +, v_1);
    u32 m2_0 = U32_BIN(U32_BIN(m1_0, *, 2654435761ull), +, v_2);
    u32 m3_0 = U32_BIN(U32_BIN(m2_0, *, 2654435761ull), +, v_3);
    u32 m4_0 = U32_BIN(U32_BIN(m3_0, *, 2654435761ull), +, v_4);
    u32 m5_0 = U32_BIN(U32_BIN(m4_0, *, 2654435761ull), +, v_5);
    u32 m6_0 = U32_BIN(U32_BIN(m5_0, *, 2654435761ull), +, v_6);
    u32 m7_0 = U32_BIN(U32_BIN(m6_0, *, 2654435761ull), +, v_7);
    if (seq) {
      WL_ROOM(2);
      STK(0) = m7_0;
      STK(1) = FID_REND_K27;
      ...
      u64 t_1 = task_node(e, FID_REND_K27, WL_CONT, WL_IDX, 1);
      e.mem[t_1 + 0] = m7_0;
      WL_CONT = term_tsk(FID_REND_K27, t_1);
      WL_IDX = 1;
    }
    r0 = nat_chk(e, hd_1 + 6ull);
    r1 = 0ull;
    r2 = tn_1;
    r3 = v_0;
    r4 = v_1;
  ...
  WL_CASE(FID_REND_K27)
  {
    WL_POPN(1);
    u32 m7_1 = STK(0);
    u32 r_0 = r0;
    WL_OPEN
    r0 = U32_BIN(U32_BIN(m7_1, *, 2654435761ull), +, r_0);
    WL_RETN(1);
  }}
  ...
  WL_CASE(FID_MAIN)
  {
    ...
    if (seq) {
      ...
      u64 t_0 = task_node(e, FID_MAIN_K30, WL_CONT, WL_IDX, 1);
      WL_CONT = term_tsk(FID_MAIN_K30, t_0);
      WL_IDX = 0;
      u64 t_1 = task_node(e, FID_REND, WL_CONT, WL_IDX, 0);
      e.mem[t_1 + 0] = 18ull;
      e.mem[t_1 + 1] = 51ull;
      return term_tsk(FID_REND, t_1);
    }
    r0 = 18ull;
    r1 = 51ull;
    WL_JMP(FID_REND);
  ...
  WL_CASE(FID_MAIN_K30)
  {
    ...
    if (seq) {
      ...
      u64 t_2 = task_node(e, FID_MAIN_K31, WL_CONT, WL_IDX, 1);
      WL_CONT = term_tsk(FID_MAIN_K31, t_2);
      WL_IDX = 0;
    }
    r0 = h_0;
    WL_JMP(FID_U32_SHOW);
