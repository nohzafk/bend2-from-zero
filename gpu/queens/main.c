...
#define FID_SOLVE 0
#define FID_SOLVE_K1 1
#define FID_SOLVE_K2 2
#define FID_U32_SHOW_GO 3
#define FID_BATCH 4
#define FID_BATCH_K17 5
#define FID_BATCH_K18 6
#define FID_BATCH_J17 7
#define FID_RUN 8
#define FID_RUN_K26 9
#define FID_U32_SHOW 10
#define FID_MAIN 11
#define FID_MAIN_K29 12
#define FID_MAIN_K30 13
#define FID_IO_PRINT 14
#define FID_IO_EMIT 15
#define FID_CLO_APPLY 16
#define FID_EXIT 17
#define FID_ENTER 18
CONSTV u8 FID_ARITY_T[] = { 16, 11, 11, 3, 6, 9, 6, 6, 3, 3, 1, 0, 1, 1, 2, 1, 2 };
CONSTV u8 FID_FLAG_T[] = { 2, 2, 2, 2, 0, 0, 2, 2, 1, 2, 2, 0, 2, 2, 2, 2, 0 };
CONSTV u8 FID_RESW_T[] = { 0, 3, 3, 0, 0, 3, 3, 0, 0, 3, 0, 0, 1, 1, 0, 0, 0 };
CONSTV u8 CID_ARITY_T[] = { 2, 0, 2, 2, 1, 2, 1, 1, 0, 1, 0, 0, 0, 1, 0, 2, 2 };
#define STAT_LEN 2
...
#define WL_TABLE WL_X(FID_SOLVE) WL_X(FID_SOLVE_K1) WL_X(FID_SOLVE_K2) WL_X(FID_U32_SHOW_GO) WL_X(FID_BATCH) WL_X(FID_BATCH_K17) WL_X(FID_BATCH_K18) WL_X(FID_BATCH_J17) WL_X(FID_RUN) WL_X(FID_RUN_K26) WL_X(FID_U32_SHOW) WL_X(FID_MAIN) WL_X(FID_MAIN_K29) WL_X(FID_MAIN_K30) WL_X(FID_IO_PRINT) WL_X(FID_IO_EMIT) WL_X(FID_CLO_APPLY) WL_X(FID_EXIT)
...
INLINE Term spin_1(Env e, THR Term* o, u32 r0, u32 r1, u32 r2, u32 r3, u32 r4, u32 r5) {
  u32 wpoll = 0;
  u32 v_3 = 0;
  u32 v_4 = 0;
  u32 v_5 = 0;
  ...
  WL_SPIN
    if (a_22 == 1) {
      if (b_6 == 1) {
        v_3 = 1;
        v_4 = U32_BIN(a_23, +, b_7);
        v_5 = U32_BIN(a_24, +, b_8);
      } else {
        v_3 = 1;
        v_4 = a_23;
        v_5 = a_24;
...
INLINE Term spin_4(Env e, THR Term* o, u32 r0, u32 r1, u32 r2) {
  u32 wpoll = 0;
  u32 v_10 = 0;
  u32 t_0 = r0;
  u32 x_1 = r1;
  ...
  WL_SPIN
    u32 v_11 = 0;
    Term o_3[1];
    if (spin_0(e, o_3, x_1, y_0, U32_BIN(t_0, ==, 0)) == 0) {
      return 0;
    }
    v_11 = o_3[0];
    v_10 = v_11;
...
INLINE Term spin_5(Env e, THR Term* o, u32 r0, u32 r1, u32 r2) {
  u32 wpoll = 0;
  u32 v_13 = 0;
  u32 st_0 = r0;
  u32 st_1 = r1;
  ...
  WL_SPIN
    if (st_0 == 0) {
      ...
      v_13 = U32_BIN(U32_BIN(st_1, *, 2654435761ull), ^, st_2);
    }
  break;
  }
  o[0] = v_13;
...
// ========
  ...
  WL_CASE(FID_SOLVE)
  {
    ...
    if (f_0 == 0) {
      if (ret_0 == 0) {
        ...
        r0 = 1;
        r1 = U32_BIN(sols_0, +, ret_1);
        r2 = U32_BIN(nodes_0, +, ret_2);
        WL_RETN(3);
      }
    } else {
      Term g_0 = (f_0 - 1);
      if (z_0 == 1) {
        ...
        if (e_0 == 1) {
          if (ret_0 == 0) {
            u32 b2_0 = U32_BIN(sib_0, &, U32_BIN(0ull, -, sib_0));
            u32 n2_0 = U32_BIN(cols_0, |, b2_0);
            r0 = g_0;
            r1 = U32_BIN(sib_0, ==, 0);
            r2 = U32_BIN(n2_0, ==, full_0);
            r3 = U32_BIN(sib_0, -, b2_0);
            r4 = n2_0;
            r5 = U32_BIN(U32_BIN(ld_0, |, b2_0), <<, 1);
            r6 = U32_BIN(U32_BIN(rd_0, |, b2_0), >>, 1);
            r7 = cols_0;
            r8 = ld_0;
            r9 = rd_0;
            r10 = full_0;
            ...
            r12 = 0;
            r13 = 0;
            r14 = U32_BIN(sols_0, +, 1);
            r15 = U32_BIN(nodes_0, +, 1);
            f_0 = r0;
            z_0 = r1;
            e_0 = r2;
            sib_0 = r3;
            ...
            u32 b2_1 = U32_BIN(sib_0, &, U32_BIN(0ull, -, sib_0));
            u32 n2_1 = U32_BIN(cols_0, |, b2_1);
            r0 = g_0;
            r1 = U32_BIN(sib_0, ==, 0);
            r2 = U32_BIN(n2_1, ==, full_0);
            r3 = U32_BIN(sib_0, -, b2_1);
            r4 = n2_1;
            r5 = U32_BIN(U32_BIN(ld_0, |, b2_1), <<, 1);
            r6 = U32_BIN(U32_BIN(rd_0, |, b2_1), >>, 1);
            r7 = cols_0;
            r8 = ld_0;
            r9 = rd_0;
            r10 = full_0;
            ...
            r12 = 0;
            r13 = 0;
            r14 = U32_BIN(U32_BIN(sols_0, +, ret_1), +, 1);
            r15 = U32_BIN(U32_BIN(nodes_0, +, ret_2), +, 1);
            f_0 = r0;
            z_0 = r1;
            e_0 = r2;
            sib_0 = r3;
          ...
          if (ret_0 == 0) {
            u32 cc_0 = U32_BIN(full_0, &, ((u64)~(u32)(U32_BIN(nc_0, |, U32_BIN(nl_0, |, nr_0)))));
            u32 cb_0 = U32_BIN(cc_0, &, U32_BIN(0ull, -, cc_0));
            u32 cn_0 = U32_BIN(nc_0, |, cb_0);
            u32 b2_2 = U32_BIN(sib_0, &, U32_BIN(0ull, -, sib_0));
            u32 n2_2 = U32_BIN(cols_0, |, b2_2);
            if (seq) {
              WL_ROOM(9);
              STK(0) = g_0;
              STK(1) = sib_0;
              ...
              u64 t_0 = task_node(e, FID_SOLVE_K1, WL_CONT, WL_IDX, 1);
              e.mem[t_0 + 0] = g_0;
              e.mem[t_0 + 1] = sib_0;
              e.mem[t_0 + 2] = cols_0;
              e.mem[t_0 + 3] = ld_0;
              ...
              e.mem[t_0 + 6] = b2_2;
              e.mem[t_0 + 7] = n2_2;
              WL_CONT = term_tsk(FID_SOLVE_K1, t_0);
              WL_IDX = 8;
            }
            r0 = g_0;
            r1 = U32_BIN(cc_0, ==, 0);
            r2 = U32_BIN(cn_0, ==, full_0);
            r3 = U32_BIN(cc_0, -, cb_0);
            r4 = cn_0;
            r5 = U32_BIN(U32_BIN(nl_0, |, cb_0), <<, 1);
            r6 = U32_BIN(U32_BIN(nr_0, |, cb_0), >>, 1);
            r7 = nc_0;
            r8 = nl_0;
            r9 = nr_0;
            r10 = full_0;
            ...
            u32 cc_1 = U32_BIN(full_0, &, ((u64)~(u32)(U32_BIN(nc_0, |, U32_BIN(nl_0, |, nr_0)))));
            u32 cb_1 = U32_BIN(cc_1, &, U32_BIN(0ull, -, cc_1));
            u32 cn_1 = U32_BIN(nc_0, |, cb_1);
            u32 b2_4 = U32_BIN(sib_0, &, U32_BIN(0ull, -, sib_0));
            u32 n2_4 = U32_BIN(cols_0, |, b2_4);
            if (seq) {
              WL_ROOM(9);
              STK(0) = g_0;
              STK(1) = sib_0;
              ...
              u64 t_1 = task_node(e, FID_SOLVE_K2, WL_CONT, WL_IDX, 1);
              e.mem[t_1 + 0] = g_0;
              e.mem[t_1 + 1] = sib_0;
              e.mem[t_1 + 2] = cols_0;
              e.mem[t_1 + 3] = ld_0;
              ...
              e.mem[t_1 + 6] = b2_4;
              e.mem[t_1 + 7] = n2_4;
              WL_CONT = term_tsk(FID_SOLVE_K2, t_1);
              WL_IDX = 8;
            }
            r0 = g_0;
            r1 = U32_BIN(cc_1, ==, 0);
            r2 = U32_BIN(cn_1, ==, full_0);
            r3 = U32_BIN(cc_1, -, cb_1);
            r4 = cn_1;
            r5 = U32_BIN(U32_BIN(nl_0, |, cb_1), <<, 1);
            r6 = U32_BIN(U32_BIN(nr_0, |, cb_1), >>, 1);
            r7 = nc_0;
            r8 = nl_0;
            r9 = nr_0;
            r10 = full_0;
  ...
  WL_CASE(FID_SOLVE_K1)
  {
    ...
    r0 = g_1;
    r1 = U32_BIN(sib_1, ==, 0);
    r2 = U32_BIN(n2_3, ==, full_1);
    r3 = U32_BIN(sib_1, -, b2_3);
    r4 = n2_3;
    r5 = U32_BIN(U32_BIN(ld_1, |, b2_3), <<, 1);
    r6 = U32_BIN(U32_BIN(rd_1, |, b2_3), >>, 1);
    r7 = cols_1;
    r8 = ld_1;
    r9 = rd_1;
    r10 = full_1;
  ...
  WL_CASE(FID_SOLVE_K2)
  {
    ...
    r0 = g_2;
    r1 = U32_BIN(sib_2, ==, 0);
    r2 = U32_BIN(n2_5, ==, full_2);
    r3 = U32_BIN(sib_2, -, b2_5);
    r4 = n2_5;
    r5 = U32_BIN(U32_BIN(ld_2, |, b2_5), <<, 1);
    r6 = U32_BIN(U32_BIN(rd_2, |, b2_5), >>, 1);
    r7 = cols_2;
    r8 = ld_2;
    r9 = rd_2;
    r10 = full_2;
  ...
  WL_CASE(FID_BATCH)
  {
    ...
    WL_SPIN
    if (d_0 == 0) {
      u32 i_1 = U32_BIN(U32_BIN(i_0, *, 2654435761ull), &, m_0);
      u32 s_0 = U32_BIN(i_1, <, bound_0);
      if (s_0 == 0) {
        r0 = 1;
        r1 = 0ull;
        r2 = 0ull;
        ...
        u32 nn2_0 = U32_BIN(nn_0, *, nn_0);
        Term a_0 = U32_BIN(nn2_0, *, nn_0);
        Term a_1 = 1ull;
        Term a_2 = ((u32)(a_0) == 0 ? 0 : U32_BIN(i_1, /, a_0));
        u32 b0_0 = (a_2 >= 32 ? 0 : U32_BIN(a_1, <<, a_2));
        Term a_3 = ((u32)(nn2_0) == 0 ? 0 : U32_BIN(i_1, /, nn2_0));
        Term a_4 = 1ull;
        Term a_5 = ((u32)(nn_0) == 0 ? a_3 : U32_BIN(a_3, %, nn_0));
        u32 b1_0 = (a_5 >= 32 ? 0 : U32_BIN(a_4, <<, a_5));
        u32 s_1 = U32_BIN(U32_BIN(b1_0, &, U32_BIN(b0_0, |, U32_BIN(U32_BIN(b0_0, <<, 1), |, U32_BIN(b0_0, >>, 1)))), ==, 0ull);
        if (s_1 == 0) {
          r0 = 1;
          r1 = 0ull;
          r2 = 0ull;
          ...
          Term a_6 = ((u32)(nn_0) == 0 ? 0 : U32_BIN(i_1, /, nn_0));
          Term a_7 = 1ull;
          Term a_8 = ((u32)(nn_0) == 0 ? a_6 : U32_BIN(a_6, %, nn_0));
          u32 b2_0 = (a_8 >= 32 ? 0 : U32_BIN(a_7, <<, a_8));
          u32 c2_0 = U32_BIN(b0_0, |, b1_0);
          u32 l2_0 = U32_BIN(U32_BIN(U32_BIN(b0_0, <<, 1), |, b1_0), <<, 1);
          u32 r2_0 = U32_BIN(U32_BIN(U32_BIN(b0_0, >>, 1), |, b1_0), >>, 1);
          u32 s_2 = U32_BIN(U32_BIN(b2_0, &, U32_BIN(c2_0, |, U32_BIN(l2_0, |, r2_0))), ==, 0ull);
          if (s_2 == 0) {
            r0 = 1;
            r1 = 0ull;
            r2 = 0ull;
            ...
            Term a_9 = 1ull;
            Term a_10 = ((u32)(nn_0) == 0 ? i_1 : U32_BIN(i_1, %, nn_0));
            u32 b3_0 = (a_10 >= 32 ? 0 : U32_BIN(a_9, <<, a_10));
            u32 c3_0 = U32_BIN(c2_0, |, b2_0);
            u32 l3_0 = U32_BIN(U32_BIN(l2_0, |, b2_0), <<, 1);
            u32 r3_0 = U32_BIN(U32_BIN(r2_0, |, b2_0), >>, 1);
            u32 s_3 = U32_BIN(U32_BIN(b3_0, &, U32_BIN(c3_0, |, U32_BIN(l3_0, |, r3_0))), ==, 0ull);
            if (s_3 == 0) {
              r0 = 1;
              r1 = 0ull;
              r2 = 0ull;
              ...
              u32 c4_0 = U32_BIN(c3_0, |, b3_0);
              u32 l4_0 = U32_BIN(U32_BIN(l3_0, |, b3_0), <<, 1);
              u32 r4_0 = U32_BIN(U32_BIN(r3_0, |, b3_0), >>, 1);
              u32 cc_0 = U32_BIN(full_0, &, ((u64)~(u32)(U32_BIN(c4_0, |, U32_BIN(l4_0, |, r4_0)))));
              u32 cb_0 = U32_BIN(cc_0, &, U32_BIN(0ull, -, cc_0));
              u32 cn_0 = U32_BIN(c4_0, |, cb_0);
              r0 = nn2_0;
              r1 = U32_BIN(cc_0, ==, 0);
              r2 = U32_BIN(cn_0, ==, full_0);
              r3 = U32_BIN(cc_0, -, cb_0);
              r4 = cn_0;
              r5 = U32_BIN(U32_BIN(l4_0, |, cb_0), <<, 1);
              r6 = U32_BIN(U32_BIN(r4_0, |, cb_0), >>, 1);
              r7 = c4_0;
              r8 = l4_0;
              r9 = r4_0;
              r10 = full_0;
      ...
      if (!seq) {
        Term a_11 = 1ull;
        u64 t_0 = task_node(e, FID_BATCH_J17, WL_CONT, WL_IDX, 2);
        u64 t_1 = task_node(e, FID_BATCH, term_tsk(FID_BATCH_J17, t_0), 0, 0);
        e.mem[t_1 + 0] = p_0;
        e.mem[t_1 + 1] = i_0;
        e.mem[t_1 + 2] = m_0;
        e.mem[t_1 + 3] = nn_0;
        e.mem[t_1 + 4] = full_0;
        e.mem[t_1 + 5] = bound_0;
        e.mem[t_0 + 0] = term_tsk(FID_BATCH, t_1);
        u64 t_2 = task_node(e, FID_BATCH, term_tsk(FID_BATCH_J17, t_0), 3, 0);
        e.mem[t_2 + 0] = p_0;
        e.mem[t_2 + 1] = U32_BIN(i_0, +, (p_0 >= 32 ? 0 : U32_BIN(a_11, <<, p_0)));
        e.mem[t_2 + 2] = m_0;
        e.mem[t_2 + 3] = nn_0;
        e.mem[t_2 + 4] = full_0;
        e.mem[t_2 + 5] = bound_0;
        e.mem[t_0 + 3] = term_tsk(FID_BATCH, t_2);
        return term_tsk(FID_BATCH_J17, t_0);
      }
      WL_ROOM(7);
      STK(0) = p_0;
      STK(1) = i_0;
  ...
  WL_CASE(FID_BATCH_K17)
  {
    ...
    WL_PUSHN(4);
    r0 = p_1;
    r1 = U32_BIN(i_2, +, (p_1 >= 32 ? 0 : U32_BIN(a_15, <<, p_1)));
    r2 = m_1;
    r3 = nn_1;
    r4 = full_1;
    r5 = bound_1;
  ...
  WL_CASE(FID_BATCH_K18)
  {
    ...
    r4 = b_1;
    r5 = b_2;
    WL_JMP(FID_BATCH_J17);
  }}

  WL_CASE(FID_BATCH_J17)
  {
    u32 a_19 = r0;
    u32 a_20 = r1;
    u32 a_21 = r2;
    ...
    u32 v_2 = 0;
    Term o_0[3];
    if (spin_1(e, o_0, a_19, a_20, a_21, b_3, b_4, b_5) == 0) {
      return 0;
    }
    v_0 = o_0[0];
    v_1 = o_0[1];
  ...
  WL_CASE(FID_RUN)
  {
    ...
    u32 v_4 = 0;
    Term o_1[1];
    if (spin_2(e, o_1, v_1) == 0) {
      return 0;
    }
    v_4 = o_1[0];
    v_0 = v_4;
    Term a_0 = 1ull;
    u32 full_0 = U32_BIN((n_0 >= 32 ? 0 : U32_BIN(a_0, <<, n_0)), -, 1ull);
    Term a_1 = 1ull;
    u32 v_5 = 0;
    u32 v_6 = 0;
    u32 v_7 = 0;
    Term o_2[1];
    if (spin_3(e, o_2, U32_BIN(lim_0, <, v_0)) == 0) {
      return 0;
    }
    v_7 = o_2[0];
    v_6 = v_7;
    u32 v_9 = 0;
    Term o_4[1];
    if (spin_4(e, o_4, v_6, v_0, lim_0) == 0) {
      return 0;
    }
    v_9 = o_4[0];
    v_5 = v_9;
    if (seq) {
      ...
      u64 t_1 = task_node(e, FID_RUN_K26, WL_CONT, WL_IDX, 1);
      WL_CONT = term_tsk(FID_RUN_K26, t_1);
      WL_IDX = 0;
    }
    r0 = d_0;
    r1 = 0ull;
    r2 = U32_BIN((d_0 >= 32 ? 0 : U32_BIN(a_1, <<, d_0)), -, 1ull);
    r3 = n_0;
    r4 = full_0;
    r5 = v_5;
    WL_JMP(FID_BATCH);
  ...
  WL_CASE(FID_MAIN)
  {
    ...
    if (seq) {
      ...
      u64 t_0 = task_node(e, FID_MAIN_K29, WL_CONT, WL_IDX, 1);
      WL_CONT = term_tsk(FID_MAIN_K29, t_0);
      WL_IDX = 0;
      u64 t_1 = task_node(e, FID_RUN, WL_CONT, WL_IDX, 0);
      e.mem[t_1 + 0] = 17ull;
      e.mem[t_1 + 1] = 17ull;
      e.mem[t_1 + 2] = 11730ull;
      return term_tsk(FID_RUN, t_1);
    }
    r0 = 17ull;
    r1 = 17ull;
    r2 = 11730ull;
