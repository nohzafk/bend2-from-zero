...
CHECKS = [
    ...
    C("life/life_par @1t", "bench", "life", "life_par.bend", "compile",
      ...
      book="1t: 1,735 / 1,958 / 1,936 ms"),
    C("life/life_par @10t", "bench", "life", "life_par.bend", "compile",
      args=["--threads", "10"], runs=2, timeout_s=300,
      expect_out=["blk=1", "blk=16", "blk=64", "naive, no fork"],
      book="10t: 676 / 628 / 986 ms"),
    C("life/life_rowpar @1t", "bench", "life", "life_rowpar.bend", "compile",
      args=["--threads", "1"], runs=2, timeout_s=300,
      expect_out=["256x256", "512x512", "d=0", "d=2", "d=3", "d=4"],
      book="1t: walk 272-295 / 1,439-1,443 ms; 4-leaf tree 369 / 1,945-1,948 ms"),
    C("life/life_rowpar @4t", "bench", "life", "life_rowpar.bend", "compile",
      args=["--threads", "4"], runs=2, timeout_s=300,
      expect_out=["256x256", "512x512", "d=0", "d=2", "d=3", "d=4"],
      book="4t: 4-leaf tree 210 / 1,127-1,157 ms (1.4x over the walk)"),
    C("life/life_rowpar @10t", "bench", "life", "life_rowpar.bend", "compile",
      args=["--threads", "10"], runs=2, timeout_s=300,
      expect_out=["256x256", "512x512", "d=0", "d=2", "d=3", "d=4"],
      book="10t: 258-328 / 1,088-1,428 ms (no reliable gain over 4t)"),
