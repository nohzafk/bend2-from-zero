...
The book is written against **Bend 2.0.24**, and Bend moves fast. This directory
...
python3 tools/drift/run_drift.py --label 2.0.24  # name the report yourself
```
...
(`drift-2.0.24-only-probes-ok.md`), so a diagnostic sweep cannot replace the
